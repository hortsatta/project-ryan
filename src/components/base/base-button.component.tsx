...
export const BaseButton = memo(function ({
    ...
    return (
      ...
      >
        ...
        <div className='relative px-5 h-full flex justify-center items-center bg-gradient-to-r from-primary to-accent'>
          <div className='relative text-default text-white tracking-[3.5px] z-10'>
            {children}
          </div>
  ...
  return (
    <button
      className={cx(
        'py-3 px-6 inline-flex justify-center items-center gap-2 rounded-md border border-transparent uppercase text-default text-white\
